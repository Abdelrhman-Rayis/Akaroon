...
define('OWA_DB_NAME', 'akaroon_a-owa-l4a'); // name of the database
define('OWA_DB_HOST', 'localhost'); // host name of the server housing the database
define('OWA_DB_USER', 'akaroon_a-owa-l4a'); // database user
define('OWA_DB_PASSWORD', 'V9-BtnDCr'); // database user's password
...
define('OWA_PUBLIC_URL', 'http://akaroon.com/statss/');
