...
<section class="ak-letter-section">
  <div class="container">
    <div class="ak-letter-card">

      <!-- Header / Toggle button -->
      <div class="ak-letter-header">
        <div class="ak-letter-avatar">✍️</div>
        <div class="ak-letter-info">
          <div class="ak-letter-from">رسالة من أخوكم</div>
          <div class="ak-letter-name">بروفسير إبراهيم أحمد عمر</div>
        </div>
      ...
      <div class="collapse" id="professorLetter">
        <div class="ak-letter-body">
          ...
          <a href="/blog/" class="ak-letter-readmore">← اقرأ الرسالة كاملة على المدونة</a>
        </div>
      </div>
