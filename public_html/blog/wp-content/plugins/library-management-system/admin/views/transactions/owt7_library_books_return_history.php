    ...
    <div class="lms-borrow-history">
        ...
        <div class="page-header">
            <div class="breadcrumb"> 
                ...
                <span class="active"><?php esc_html_e("Book(s) Return History", "library-management-system"); ?></span> 
            </div>
        ...
        <div class="page-container">
            ...
            <div class="page-title">
                <h2><?php esc_html_e("Book(s) Return History", "library-management-system"); ?></h2>
            </div>
            ...
            <table class="owt7-lms-table" id="tbl_books_return_history">
                <thead>
                    <tr>
                        ...
                        <th><?php esc_html_e("Fine Status", "library-management-system"); ?></th>
