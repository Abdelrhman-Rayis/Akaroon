...
function salat_times_options_page() {
	...
	print(
		'<div class="wrap">
		<h1 style="margin-bottom:5px;">Salat Times Settings <a href="#how" class="button button-secondary">How to use?</a> <a href="#help" class="button button-secondary">Help</a> <a href="#custom_plug" class="button button-secondary">Requset Customization</a> <a target="_blank" href="https://paypal.me/imran2p" class="button button-primary">Donate with PayPal</a></h1>
		<br/>'
	);
	...
	<form id="auto_options" method="post" action="options.php">
		...
		<div class="postbox">
			<h3 class="hndle" style="padding: 10px; margin: 0;"><span>Timetable Type</span></h3>
			<div class="inside">
				<table class="form-table">
					<tr valign="top">
						<td><label for="type">Timetable Type:</label>
						</td>
						<td>
							<select name="st_options[timetable]" id="type">
								<option value="0" <?php if($st_options[ 'timetable']=="0" ) { echo " selected"; } ?>>Automatic</option>
								<option value="1" <?php if($st_options[ 'timetable']=="1" ) { echo " selected"; } ?>>Manual</option>
							</select>
						</td>
						<td>
							<p><i>Note: <strong>Automatic</strong> option will display Wakto start time only. <strong>Manual</strong> option will display Wakto start time + Jama'h time.</i>
							</p>
						</td>
					</tr>
				</table>
		...
		<div class="postbox">
			<h3 class="hndle" style="padding: 10px; margin: 0;"><span>Location Settings for Automatic Timetable</span></h3>
			<div class="inside">
				...
				<table class="form-table">
					<tr valign="top">
						<td><input type="radio" id="custom_loc0" name="st_options[custom_loc]" value="0" <?php if($st_options[ 'custom_loc']=="0" ) { echo " checked"; } ?>><label for="custom_loc0">Select City:</label>
						</td>
						<td>
					...
					<tr valign="top">
						<td><input type="radio" id="custom_loc1" name="st_options[custom_loc]" value="1" <?php if($st_options[ 'custom_loc']=="1" ) { echo " checked"; } ?>><label for="custom_loc1">Custom Location:</label>
						</td>
						<td>
							Latitude:<input type="text" maxlength="7" size="5" name="st_options[lat]" value="<?php echo $st_options['lat']; ?>"/> Longitude:<input type="text" maxlength="7" size="5" name="st_options[long]" value="<?php echo $st_options['long']; ?>"/> Time Zone:
		...
		<div class="postbox">
			<h3 class="hndle" style="padding: 10px; margin: 0;"><span>Calculation Settings for Automatic Timetable</span></h3>
			<div class="inside">
				<table class="form-table">
					<tr valign="top">
					...
					<tr valign="top">
						<td><label for="highlats">Higher Latitudes Method</label> (<a href="#help">?</a>):</td>
						<td>
			...
			<div class="inside">
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td><input id="ln" type="text" maxlength="99" name="st_options[location]" value="<?php echo $st_options['location']; ?>"/> <span style="color: green;">(Will be displayed on widget.)</span>
						</td>
					</tr>
					<tr valign="top">
					...
					<tr valign="top">
						...
						<td>
							...
							<p><input id="shd" type="checkbox" id="show_hdate" name="st_options[show_hdate]" value="1" <?php if($st_options[ 'show_hdate']==1) echo( 'checked="checked"'); ?>/><label for="shd">Hijri Date</label>
							</p>
						</td>
					</tr>
					<tr valign="top">
						...
						<td><input id="hijri_adjust" type="text" maxlength="3" size="4" name="st_options[hijri_adjust]" value="<?php echo $st_options['hijri_adjust']; ?>"/> Hours</td>
					</tr>
					<tr valign="top">
					...
					<tr valign="top">
						...
						<td>
							...
							<p><input size="60" id="cl" type="text" name="st_options[custom]" value="<?php echo $st_options['custom']; ?>"/>
							</p>
						</td>
					</tr>
				</table>
	...
	<div class="postbox">
		...
		<div class="inside">
			...
			$url = admin_url( 'options-general.php?page=salat_times', 'http' );
			...
			<form action="" method="post">
				<textarea placeholder="input text" rows="10" cols="100" name="text"><?php echo htmlspecialchars($text) ?></textarea>
				<br/>
	...
	<div class="postbox">
		<h3 class="hndle" style="padding: 10px; margin: 0;"><span>Backup/Restore</span></h3>
		<div class="inside">
			<p>Here you can download backups of your settings/data and restore them when you need.</p>
			<table class="form-table">
				<tr valign="top">
					<td><strong><u>Backups</u></strong>
					</td>
					<td><strong><u>Download</u></strong>
					</td>
					<td><strong><u>Restore Backups</u></strong>
					</td>
				</tr>
				<tr valign="top">
					<td>1. Manual Time Data</td>
					<td><a class="button button-secondary" href="<?php echo WP_CONTENT_URL.'/plugin_data/salat-times/manual_time.data'; ?>" download>Download Backup</a>
					</td>
					<td>Upload the <strong>manual_time.data</strong> backup file to <strong>wp-contents/plugin_data/salat-times</strong> folder.</td>
				</tr>
				<tr valign="top">
					<td>2. Plugin Settings</td>
					<td><span class="button button-secondary">Not Available Yet</span>
					</td>
					<td>Plugin settings restore option not available yet.</td>
				</tr>
			</table>
		</div>
	</div>
	...
	<div class="postbox">
		...
		<div class="inside">
			<table class="form-table">
				<tr valign="top">
					<td>
						<p>If you like this plugin, please donate...<br/>
							<a target="_blank" href="https://paypal.me/imran2p">
								<?php echo '<img src="' . plugins_url( 'paypal_donate.gif', __FILE__ ) . '" > '; ?>
							</a>
						</p>
						<p><a href="http://facebook.com/imran2w" target="_blank"><img src="http://www.gravatar.com/avatar/<?php echo md5( "imran2w@gmail.com" ); ?>" /></a>
						</p>
						<p>Developer: <a href="http://facebook.com/imran2w">M.A. IMRAN</a><br/> E-Mail: imran2w@gmail.com<br/> Web: <a target="_blank" href="http://i-onlinemedia.net">www.i-onlinemedia.net</a> - <a target="_blank" href="http://xhostbd.com">www.xhostbd.com</a>
						</p><br/>
