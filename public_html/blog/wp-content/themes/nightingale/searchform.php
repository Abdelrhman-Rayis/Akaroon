...
<div class="nhsuk-header__search-wrap" <?php echo esc_attr( $wrap_search ); ?>>
	<form class="nhsuk-header__search-form" <?php echo esc_attr( $search_form ); ?> action="ibrahimfinalsearch.php" method="get" role="search">
		...
		<input style="width: 500px; text-align: center; position: relative; color: black; direction: rtl;" type="text" name="search" class="form-control" placeholder="هنا يمكنك البحث عن طريق عنوان الورقة أو الكتاب أو المؤلف أو مجال البحث" />
		<button class="nhsuk-search__submit" type="submit" name="search_btn">
			<svg class="nhsuk-icon nhsuk-icon__search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
				<path d="M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z"></path>
			</svg>
