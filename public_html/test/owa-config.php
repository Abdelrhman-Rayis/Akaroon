...
define('OWA_DB_NAME', 'akaroon_a-owa-30x'); // name of the database
define('OWA_DB_HOST', 'localhost'); // host name of the server housing the database
define('OWA_DB_USER', 'akaroon_a-owa-30x'); // database user
define('OWA_DB_PASSWORD', 'BYk6rF7b-'); // database user's password
...
define('OWA_PUBLIC_URL', 'http://akaroon.com/test/');
