<?php
//index.php
$connect = mysqli_connect("mysql", "root", "root", "testing");
 ...
 <body>
   <div class="sidebar-fixed position-fixed">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="add-record-form.php" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-user mr-3"></i>Add Case</a>
        <a href="followup.php" class="list-group-item active waves-effect">
  ...
  <div id="formContent">
    ...
    <form>
      ...
      <a  href="dash/dashboard.html"> 
            ...
            <input type="submit" class="fadeIn fourth" value="Log In" ></div>
</a>
    </form>
