    ...
    <div class="flex">
            ...
            <input type="submit" name="search_btn" class="btn btn-default" value="Search"  />
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(The_number_of_the_Author) FROM org ORDER BY The_number_of_the_Author";
                    $orgment = $connect->prepare($query);
                    $orgment->execute();
                    $result = $orgment->fetchAll();
                ...
                <div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(Field_of_research) FROM org  ORDER BY Field_of_research
                    ";
                    $orgment = $connect->prepare($query);
                    $orgment->execute();
                    $result = $orgment->fetchAll();
                ...
                <div class="list-group">
                    ...
                    <?php
                    $query = "
                    SELECT DISTINCT(Place_of_issue) FROM org ORDER BY Place_of_issue
                    ";
                    $orgment = $connect->prepare($query);
                    $orgment->execute();
                    $result = $orgment->fetchAll();
