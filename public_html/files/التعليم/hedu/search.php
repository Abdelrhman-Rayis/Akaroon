    ...
    <div class="flex">
            ...
            <input type="submit" name="search_btn" class="btn btn-default" value="Search"  />
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(The_number_of_the_Author) FROM edu ORDER BY The_number_of_the_Author";
				...
				<div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(Field_of_research) FROM edu  ORDER BY Field_of_research
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
				...
				<div class="list-group">
					...
					<?php
                    $query = "
                    SELECT DISTINCT(Place_of_issue) FROM edu ORDER BY Place_of_issue
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
