    ...
    <div class="flex">
            ...
            <input type="submit" name="search_btn" class="btn btn-default" value="Search"  />
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(The_number_of_the_Author) FROM soc ORDER BY The_number_of_the_Author";
                    $socment = $connect->prepare($query);
                    $socment->execute();
                    $result = $socment->fetchAll();
                ...
                <div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(Field_of_research) FROM soc  ORDER BY Field_of_research
                    ";
                    $socment = $connect->prepare($query);
                    $socment->execute();
                    $result = $socment->fetchAll();
                ...
                <div class="list-group">
                    ...
                    <?php
                    $query = "
                    SELECT DISTINCT(Place_of_issue) FROM soc ORDER BY Place_of_issue
                    ";
                    $socment = $connect->prepare($query);
                    $socment->execute();
                    $result = $socment->fetchAll();
