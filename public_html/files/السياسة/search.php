    ...
    <div class="flex">
            ...
            <input type="submit" name="search_btn" class="btn btn-default" value="Search"  />
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(The_number_of_the_Author) FROM pol ORDER BY The_number_of_the_Author";
                    $polment = $connect->prepare($query);
                    $polment->execute();
                    $result = $polment->fetchAll();
                ...
                <div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(Field_of_research) FROM pol  ORDER BY Field_of_research
                    ";
                    $polment = $connect->prepare($query);
                    $polment->execute();
                    $result = $polment->fetchAll();
                ...
                <div class="list-group">
                    ...
                    <?php
                    $query = "
                    SELECT DISTINCT(Place_of_issue) FROM pol ORDER BY Place_of_issue
                    ";
                    $polment = $connect->prepare($query);
                    $polment->execute();
                    $result = $polment->fetchAll();
