    ...
    <div class="flex">
            ...
            <input type="submit" name="search_btn" class="btn btn-default" value="Search"  />
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(The_number_of_the_Author) FROM tass ORDER BY id DESC";
                    $tassment = $connect->prepare($query);
                    $tassment->execute();
                    $result = $tassment->fetchAll();
                ...
                <div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(Field_of_research) FROM tass  ORDER BY id DESC
                    ";
                    $tassment = $connect->prepare($query);
                    $tassment->execute();
                    $result = $tassment->fetchAll();
                ...
                <div class="list-group">
                    ...
                    <?php
                    $query = "
                    SELECT DISTINCT(Place_of_issue) FROM tass ORDER BY id DESC
                    ";
                    $tassment = $connect->prepare($query);
                    $tassment->execute();
                    $result = $tassment->fetchAll();
